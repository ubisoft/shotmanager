# Documentation and general concepts: https://gitlab-ncsa.ubisoft.org/animation-studio/blender/shotmanager-addon/-/wikis/Shot-Manager-Python-API
...
myShots = shot_manager.get_shots_list(sm_props, ignore_disabled=True)
