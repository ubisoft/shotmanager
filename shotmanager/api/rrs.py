...
def publishRRS(prodFilePath, take_index=-1, verbose=False, use_cache=False):
    ...
    """
    return publish_rrs.publishRRS(prodFilePath, takeIndex=take_index, verbose=verbose, useCache=use_cache)
