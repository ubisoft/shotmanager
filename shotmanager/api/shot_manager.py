...
def set_current_take_index(shot_manager, current_take_index):
    shot_manager.setCurrentTakeIndex(current_take_index)
...
def get_take_name_path_compliant(shot_manager, take_index):
    """ Return the name of the specified take with spaces replaced by "_"
    """
    return shot_manager.getTakeName_PathCompliant(take_index)
...
def get_unique_shot_name(shot_manager, name, take_index):
    return def shot_manager.getUniqueShotName(shot_manager, name, takeIndex=take_index):
...
def setCurrentShotByIndex(shot_manager, current_shot_index):
...
def getShotIndex(shot_manager, shot, take_index=-1):
    return shot_manager.getShotIndex(shot, takeIndex=take_index)

def getShot(shot_manager, shotIndex, takeIndex=-1):
...
def get_shots(shot_manager, take_index=-1):
    ...
    """
    return shot_manager.get_shots(take, takeIndex=take_index)
...
def getPreviousEnabledShotIndex(shot_manager, current_shot_index, take_index=-1):
