...
def renderStampedInfoForShot(
    ...
    render_frame_start = scene.frame_start if specificFrame is None else specificFrame
    render_frame_end = scene.frame_end if specificFrame is None else specificFrame
